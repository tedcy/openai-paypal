    ...
    *,
    ...
    _write_json(
        root / "checkpoint.json",
        {
            ...
            "approval_body_bytes": result.get("approval_body_bytes"),
            "approval_application_shape": result.get("approval_application_shape"),
            "approval_next_flight": result.get("approval_next_flight"),
            "approval_has_ssrt": result.get("approval_has_ssrt"),
            "approval_has_ctx_id": result.get("approval_has_ctx_id"),
            "approval_router_slot_count": result.get("approval_router_slot_count"),
            "roxy_api_calls": 0,
            "capture_root": str(root),
        },
    )
